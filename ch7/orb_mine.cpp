...
int main(int argc, char **argv){
    ...
    cout << "描述子匹配所需时间:" << time_used.count() << "seconds" << endl;
    cout << "匹配数量:" << matches.size() << endl;

    //画出匹配图
    cv::Mat output_img;
    cv::drawMatches(img1, keypoints1, img2, keypoints2, matches, output_img);
